...
### 6) `doc_url` 配置建议
- 查看链接：`https://github.com/itv3/sub2apiplus/blob/main/docs/ADMIN_PAYMENT_INTEGRATION_API.md`
- 下载链接：`https://raw.githubusercontent.com/itv3/sub2apiplus/main/docs/ADMIN_PAYMENT_INTEGRATION_API.md`
...
- View URL: `https://github.com/itv3/sub2apiplus/blob/main/docs/ADMIN_PAYMENT_INTEGRATION_API.md`
- Download URL: `https://raw.githubusercontent.com/itv3/sub2apiplus/main/docs/ADMIN_PAYMENT_INTEGRATION_API.md`
