...
class CandidateTestTraceTest(unittest.TestCase):
    def test_frozen_input_digests_match_checked_in_assets(self) -> None:
        ...
        target_profile = tool_root / "candidate_rule_expectations_0_156_1.json"
        target_mapping = tool_root / "candidate_test_fact_map_0_156_1.json"
    ...
    def test_default_mapping_digest_and_fact_universe_are_frozen(self) -> None:
        ...
        _, tests = load_mapping(
            tool_root / "candidate_test_fact_map_0_156_1.json",
            expected_codex_version="0.156.1",
