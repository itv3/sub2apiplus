...
// SetNillableLongContextBillingApplied 在给定值非 nil 时设置 "long_context_billing_applied" 字段。
...
// UpdateLongContextBillingApplied 将 "long_context_billing_applied" 字段设为创建时提供的值。
