...
func init() {
	...
	// usagelogDescLongContextBillingApplied 是 long_context_billing_applied 字段的模式描述符。
	usagelogDescLongContextBillingApplied := usagelogFields[26].Descriptor()
	// usagelog.DefaultLongContextBillingApplied 保存创建时 long_context_billing_applied 字段的默认值。
