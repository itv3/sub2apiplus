...
const (
	...
	// AccountTestModeCompact 执行当前严格画像的 /responses/compact 能力探针。
	AccountTestModeCompact = "compact"
	// AccountTestModeOfficialFilesProbe 执行当前 Active Codex Files 三段式出站探针。
...
// createOpenAILegacyCompactProbePayload 构造当前严格画像已批准的
// /responses/compact 管理端探测载荷。原生 v2 的普通 /responses 行为需要独立
// candidate 验收，不能在上游维护合并中替换此冻结 wire。
