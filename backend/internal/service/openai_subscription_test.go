...
func TestFetchChatGPTAccountInfo_ReportsAccountID(t *testing.T) {
	...
	got := fetchChatGPTAccountInfo(
		context.Background(),
		newTestPrivacyClientFactory(),
		"access-token",
		"",
		"",
		buildOpenAIPrivacyRolloutKey("subscription-test"),
	)
	require.NotNil(t, got)
...
func TestEnrichTokenInfo_WorkspaceEntitlementDoesNotOverridePersonalSubscription(t *testing.T) {
	...
	svc.enrichTokenInfo(context.Background(), tokenInfo, "", openAITokenEnrichmentInput{
		RolloutKey: buildOpenAIPrivacyRolloutKey(personalAccountID),
	})
...
func TestEnrichTokenInfo_WorkspacePlanTypeKeepsItsOwnExpiry(t *testing.T) {
	...
	svc := &OpenAIOAuthService{privacyClientFactory: newTestPrivacyClientFactory()}
	svc.enrichTokenInfo(context.Background(), tokenInfo, "", openAITokenEnrichmentInput{
		RolloutKey: buildOpenAIPrivacyRolloutKey(workspaceAccountID),
	})
...
func newTestPrivacyClientFactory() PrivacyClientFactory {
	return func(PrivacyClientRequest) (*PrivacyHTTPClient, error) {
